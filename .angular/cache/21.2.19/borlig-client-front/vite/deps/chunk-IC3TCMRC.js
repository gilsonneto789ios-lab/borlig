...
// prime/@primeuix/styled/node_modules/@primeuix/utils/dist/object/index.mjs
function l(e) {
...
// prime/@primeuix/styled/node_modules/@primeuix/utils/dist/eventbus/index.mjs
function s2() {
...
// prime/@primeuix/styled/node_modules/@primeuix/utils/dist/zindex/index.mjs
function g() {
  let r = [], i2 = (e, n, t = 999) => {
...
// prime/@primeuix/styled/dist/index.mjs
...
var b = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te2, extend: re2 } = a2, f = te2 || {}, { colorScheme: K } = f, A = v(f, ["colorScheme"]), x2 = re2 || {}, { colorScheme: X } = x2, G2 = v(x2, ["colorScheme"]), p = K || {}, { dark: U } = p, B = v(p, ["dark"]), y = X || {}, { dark: I } = y, H2 = v(y, ["dark"]), W = s(L) ? this._toVariables({ primitive: L }, n) : {}, q2 = s(A) ? this._toVariables({ semantic: A }, n) : {}, Z = s(B) ? this._toVariables({ light: B }, n) : {}, pe = s(U) ? this._toVariables({ dark: U }, n) : {}, fe = s(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s(H2) ? this._toVariables({ light: H2 }, n) : {}, Se = s(I) ? this._toVariables({ dark: I }, n) : {}, [Me, ze] = [(R = W.declarations) != null ? R : "", W.tokens], [Ke, Xe] = [(T = q2.declarations) != null ? T : "", q2.tokens || []], [Ge, Ue] = [(j = Z.declarations) != null ? j : "", Z.tokens || []], [Be, Ie] = [(O2 = pe.declarations) != null ? O2 : "", pe.tokens || []], [He, We] = [(M = fe.declarations) != null ? M : "", fe.tokens || []], [qe, Ze] = [(z2 = ye.declarations) != null ? z2 : "", ye.tokens || []], [Fe, Je] = [(V = Se.declarations) != null ? V : "", Se.tokens || []];
  ...
  if (s(t) && r.transform !== "strict") {
    let y = e.replace("-directive", ""), m3 = t, { colorScheme: R, extend: T, css: j } = m3, O2 = v(m3, ["colorScheme", "extend", "css"]), d = T || {}, { colorScheme: M } = d, z2 = v(d, ["colorScheme"]), u = R || {}, { dark: V } = u, L = v(u, ["dark"]), g2 = M || {}, { dark: te2 } = g2, re2 = v(g2, ["dark"]), K = s(O2) ? this._toVariables({ [y]: h(h({}, O2), z2) }, r) : {}, A = s(L) ? this._toVariables({ [y]: h(h({}, L), re2) }, r) : {}, X = s(V) ? this._toVariables({ [y]: h(h({}, V), te2) }, r) : {}, [G2, U] = [(f = K.declarations) != null ? f : "", K.tokens || []], [B, I] = [(x2 = A.declarations) != null ? x2 : "", A.tokens || []], [H2, W] = [(p = X.declarations) != null ? p : "", X.tokens || []], q2 = this.transformCSS(y, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y, H2, "dark", "variable", r, i2, a2, n);
    l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U, ...I, ...W])], c2 = m2(j, { dt: E });
  }
  ...
  let a2 = function(l2, o = {}, c2 = []) {
    ...
    Object.entries(l2).forEach(([m3, d]) => {
      let u = G(m3, t.variable.excludedKeyRegex) ? o : o ? `${o}.${oe(m3)}` : oe(m3), g2 = c2 ? `${c2}.${m3}` : m3;
...
// prime/@primeuix/styles/dist/base/index.mjs
...
// prime/primeng/fesm2022/primeng-usestyle.mjs
var _id = 0;
...
// prime/primeng/fesm2022/primeng-base.mjs
var base = {
...
// prime/primeng/fesm2022/primeng-config.mjs
